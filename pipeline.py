...
Updated for DECIMER Segmentation.
"""
    ...
    def run(self, input_data):
        ...
        try:
            ...
            for page in rendered_pages:
                page_dir = document_dir / f"page_{page.page_number:03d}"
                page_dir.mkdir(parents=True, exist_ok=True)

                crop_dir = page_dir / "crops"
                clean_dir = page_dir / "cleaned"
                redraw_png_dir = page_dir / "redraw_png"
                redraw_svg_dir = page_dir / "redraw_svg"
                ...
                for image_index, crop_path in enumerate(crop_paths, start=1):
                    ...
                    cleaned_path = clean_dir / crop_path.name
                    ...
                    if not cleaned_path.exists():
                        raise FileNotFoundError(
                            f"Cleaner failed to create: {cleaned_path}"
                        )
